...
/// TransformerJsDefault is used to build JavaScript/Typescript
/// files and is statically included in the application
pub struct TransformerJsDefault;

impl Transformer for TransformerJsDefault {
  fn transform(
    &self,
    asset: &Asset,
    code: Vec<u8>,
      ...
      _ => {
        ...
        if is_helper {
          ...
          resolve_from = Some(PathBuf::from(
            "/home/ubuntu/Development/parcel-bundler/parcel/packages/transformers/js/src/JSTransformer.js",
          ));
        }
