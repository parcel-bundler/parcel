...
///
/// The main purpose of this new-type is to allow us to return PathBuf from rust and have
/// napi auto convert it to string - for now.
///
/// For JavaScript this is just a String
///
/// ## Example
///
...
///
/// #[napi]
/// fn napi_run_my_request(input: MyRequestInput) {/* ... */}
/// ```
///
/// Then consume it from javascript
/// ```skip
/// napiRunMyRequest({ path: '/path/to/project' });
/// ```
///
