...
const Resolver = require('@parcel/resolver');
...
const {Server, HMRServer} = require('@parcel/server');
const {EventEmitter} = require('events');
const logger = require('@parcel/logger');
const PackagerRegistry = require('./PackagerRegistry');
const localRequire = require('@parcel/utils/localRequire');
const config = require('@parcel/utils/config');
const loadEnv = require('./utils/env');
const PromiseQueue = require('@parcel/utils/PromiseQueue');
...
Bundler.Packager = require('./Packager');
Bundler.SourceMap = require('./SourceMap');
