...
4. Now open http://localhost:1234/ in your browser. If needed, you can also override the default port with the -p option. Add -o to automatically open a browser.
