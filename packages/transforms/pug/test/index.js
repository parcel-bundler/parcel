...
describe('pug', function() {
  it('should support bundling HTML', async function() {
    const b = await bundle(__dirname + '/fixtures/pug/index.pug');
  ...
  it('should support include and extends files', async function() {
    const b = await bundle(
      __dirname + '/fixtures/pug-include-extends/index.pug'
    );
    ...
    const expect = await fs.readFile(
      __dirname + '/fixtures/pug-include-extends/expect.html',
      'utf-8'
    );
  ...
  it('should support variables', async function() {
    const b = await bundle(__dirname + '/fixtures/pug-var/index.pug');
  ...
  it('should support mixins', async function() {
    const b = await bundle(__dirname + '/fixtures/pug-mixins/index.pug');
  ...
  it('should support filters', async function() {
    const b = await bundle(__dirname + '/fixtures/pug-filters/index.pug');
  ...
  it('should minify HTML in production mode', async function() {
    const b = await bundle(__dirname + '/fixtures/pug-minify/index.pug', {
      production: true
    });
