    ...
    reachable = reachable.filter(b => {
      ...
      if (canBorrow) {
        for (let lender of potentialLenders) {
          borrowedAssets.get([...lender.assets][0]).add(asset);
        }
