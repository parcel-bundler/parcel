...
import { ParcelWatcherOptions, ParcelWatcherEvent, ParcelWatcherSubscription } from '@parcel/watcher';
...
export interface FileSystem {
  ...
  writeFile(filePath: string, contents: Buffer | string, options?: FileOptions): Promise<void>;
  ...
  readdirSync(path: string, opts?: { withFileTypes?: false }): string[];
  ...
  getEventsSince(dir: string, snapshot: string, opts: ParcelWatcherOptions): Promise<ParcelWatcherEvent[]>;
  writeSnapshot(dir: string, snapshot: string, opts: ParcelWatcherOptions): Promise<void>;
}
