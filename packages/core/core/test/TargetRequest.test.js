      ...
      [
        {
          ...
          env: {
            id: 'e077a4ba302fc48f6591f7d38e0db778',
            context: 'browser',
        ...
        },
        {
          ...
          env: {
            id: '6a67e554c4c0772642fd1226a486182d',
            context: 'node',
      ...
      [
        {
          ...
          publicUrl: '/',
          env: {
            id: '92612d6f51ae1afb472cc9efe707b0df',
            context: 'node',
            engines: {
              node: '>= 8.0.0',
            },
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: '10d77c8233fc6c596c883a58380830fb',
            context: 'browser',
            engines: {
        ...
        },
        {
          ...
          publicUrl: '/assets',
          env: {
            id: '9e82f7f06beb1fd51bfd933f6601eddb',
            context: 'browser',
            engines: {
              browsers: ['last 1 version'],
            },
    ...
    assert.deepEqual(
      ...
      [
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: 'e0212455ee73d8014a1903ac6cf57829',
            context: 'browser',
            engines: {
              browsers: ['last 1 version'],
            },
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: 'e0caff72b5e317196c340a910c0aede0',
            context: 'browser',
            engines: {
              browsers: ['ie11'],
            },
      ...
      [
        {
          ...
          publicUrl: 'www',
          env: {
            id: '1511d79fa3f425d5db4f2b67796ffb82',
            context: 'browser',
            engines: {
              browsers: '> 0.25%',
            },
    ...
    assert.deepEqual(await targetResolver.resolve(CONTEXT_FIXTURE_PATH), [
      {
        ...
        publicUrl: '/',
        env: {
          id: '7076bc576bb3011a86b7cdc65cda9782',
          context: 'node',
          engines: {},
          includeNodeModules: false,
          isLibrary: true,
    ...
    assert.deepEqual(await targetResolver.resolve(fixture), [
      {
        ...
        publicUrl: '/',
        env: {
          id: 'e78bcc2893c142dd30478ec0f645312d',
          context: 'browser',
          engines: {},
          includeNodeModules: true,
          isLibrary: false,
      ...
      [
        {
          ...
          publicUrl: '/',
          env: {
            id: '01b3b6beb8b56afbcc167b6ef315e4c1',
            context: 'browser',
            engines: {
              browsers: ['Chrome 80'],
            },
    ...
    assert.deepEqual(
      ...
      [
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: '6792eea24bdfb2a9d41c06869519db10',
            context: 'browser',
            engines: {
              browsers: ['IE 11'],
            },
