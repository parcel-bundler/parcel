      ...
      [
        {
          ...
          env: {
            id: 'e7cd9d6c2ce189e2155346d559f124da',
            context: 'browser',
        ...
        },
        {
          ...
          env: {
            id: '88c6aa030b5c323d44ddd4fba8409a51',
            context: 'node',
      ...
      [
        {
          ...
          publicUrl: '/',
          env: {
            id: '4439362e04eb1d639a1379a46fd2f26d',
            context: 'node',
            engines: {
              node: '>= 8.0.0',
            },
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: '199f841d6a45a8337504d9622c2ecc51',
            context: 'browser',
            engines: {
        ...
        },
        {
          ...
          publicUrl: '/assets',
          env: {
            id: 'b111425dddc116d1bf58dcdded42263f',
            context: 'browser',
            engines: {
              browsers: ['last 1 version'],
            },
    ...
    assert.deepEqual(
      ...
      [
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: 'be4b4034686d691724c827628a4402cc',
            context: 'browser',
            engines: {
              browsers: ['last 1 version'],
            },
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: '96dbec5052ea6f56f64fc71c6dcf1e60',
            context: 'browser',
            engines: {
              browsers: ['ie11'],
            },
      ...
      [
        {
          ...
          publicUrl: 'www',
          env: {
            id: 'c644b4d318b39f64a7b9f8ae242a3500',
            context: 'browser',
            engines: {
              browsers: '> 0.25%',
            },
    ...
    assert.deepEqual(await targetResolver.resolve(CONTEXT_FIXTURE_PATH), [
      {
        ...
        publicUrl: '/',
        env: {
          id: '2e3155f2ad8f53d0b0372e3a61fb66f5',
          context: 'node',
          engines: {},
          includeNodeModules: false,
          isLibrary: true,
    ...
    assert.deepEqual(await targetResolver.resolve(fixture), [
      {
        ...
        publicUrl: '/',
        env: {
          id: '73b6d6b2c100cf097953cce86dc0d020',
          context: 'browser',
          engines: {},
          includeNodeModules: true,
          isLibrary: false,
      ...
      [
        {
          ...
          publicUrl: '/',
          env: {
            id: '2e7deb1f5ce4a7c5ef18cbf9532bc52b',
            context: 'browser',
            engines: {
              browsers: ['Chrome 80'],
            },
    ...
    assert.deepEqual(
      ...
      [
        ...
        },
        {
          ...
          publicUrl: '/',
          env: {
            id: '8bf02269f37837ddd90c2547ada07e72',
            context: 'browser',
            engines: {
              browsers: ['IE 11'],
            },
