...
describe('javascript-v3', function () {
  // don't retry parcel v3 tests
  this.retries(0);
  ...
  function bundle(entries, opts) {
    ...
    return baseBundle(entries, flaggedOpts);
  }
  ...
  function bundler(entries, opts) {
    ...
    return baseBundler(entries, flaggedOpts);
  }
  ...
  it.skip('should produce a basic JS bundle with ES6 imports', async function () {
  ...
  it.skip('should detect dependencies inserted by a prior transform', async () => {
    let b = await bundle(
  ...
  it.skip('should ignore unused requires after process.env inlining', async function () {
    let b = await bundle(
  ...
  it.skip('should produce a basic JS bundle with object rest spread support', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should bundle node_modules for a browser environment', async function () {
    let b = await bundle(
  ...
  it.skip('should not bundle node_modules for a node environment', async function () {
    let b = await bundle(
  ...
  it.skip('should bundle node_modules for a node environment if includeNodeModules is specified', async function () {
    let b = await bundle(
  ...
  it.skip('should not bundle builtins for a node environment if includeNodeModules is specified', async function () {
    let b = await bundle(
  ...
  it.skip('should produce a JS bundle with default exports and no imports', async function () {
    let b = await bundle(
  ...
  it.skip('should prefetch bundles when declared as an import attribute statically', async function () {
    let b = await bundle(
      path.juoin(__dirname, '/integration/dynamic-static-prefetch/index.js'),
    );
  ...
  it.skip('dynamic imports loaded as high-priority scripts when not all engines support esmodules natively', async function () {
    let b = await bundle(
  ...
  it.skip('should deduplicate and remove an unnecessary async bundle when it contains a cyclic reference to its entry', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('does not create bundles for dynamic imports when assets are available up the graph', async () => {
    let b = await bundle(
  ...
  it.skip('should duplicate small modules across multiple bundles', async function () {
    let b = await bundle(
  ...
  it.skip('should create a separate bundle for large modules shared between bundles', async function () {
    let b = await bundle(
  ...
  it.skip('should duplicate an asset if it is not present in every parent bundle', async function () {
    let b = await bundle(
      ['a.js', 'b.js'].map(entry =>
  ...
  it.skip('should duplicate an asset if it is not available in all possible ancestries', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should support shared modules with async imports', async function () {
    let b = await bundle(
  ...
  it.skip('should support referencing a raw asset with static URL and import.meta.url', async function () {
    let b = await bundle(
  ...
  it.skip('should support referencing a raw asset with static URL and CJS __filename', async function () {
    let b = await bundle(
  ...
  it.skip('should ignore new URL and import.meta.url with local binding', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should use terser config', async function () {
  ...
  it.skip('should work when multiple files use globals with scope hoisting', async function () {
    let b = await bundle(
  ...
  it.skip('should not insert global variables when used in a module specifier', async function () {
    let b = await bundle(
  ...
  it.skip('should not insert global variables in dead branches', async function () {
    let b = await bundle(
  ...
  it.skip('should not insert environment variables in node environment', async function () {
    let b = await bundle(
  ...
  it.skip('should not replace process.env.hasOwnProperty with undefined', async function () {
    let b = await bundle(
  ...
  it.skip('should not insert environment variables in electron-main environment', async function () {
  ...
  it.skip('should not insert environment variables in electron-renderer environment', async function () {
    let b = await bundle(path.join(__dirname, '/integration/env/index.js'), {
      targets: {
        main: {
  ...
  it.skip('should inline NODE_ENV environment variable in browser environment even if disabled', async function () {
    let b = await bundle(
  ...
  it.skip('should not insert environment variables in browser environment if disabled', async function () {
    let b = await bundle(
  ...
  it.skip('should only insert environment variables in browser environment matching the glob', async function () {
    let b = await bundle(
  ...
  it.skip('should be able to inline environment variables in browser environment', async function () {
    let b = await bundle(path.join(__dirname, '/integration/env/index.js'), {
      env: {NODE_ENV: 'abc'},
    });
  ...
  it.skip("should insert the user's NODE_ENV as process.env.NODE_ENV if passed", async function () {
    let b = await bundle(path.join(__dirname, '/integration/env/index.js'), {
      env: {
        NODE_ENV: 'production',
      },
  ...
  it.skip('should not inline computed accesses to process.env', async function () {
    let b = await bundle(
  ...
  it.skip('should inline computed accesses with string literals to process.env', async function () {
    let b = await bundle(
  ...
  it.skip('should inline environment variables with in binary expression whose right branch is process.env and left branch is string literal', async function () {
    let b = await bundle(
  ...
  it.skip("should insert environment variables matching the user's NODE_ENV if passed", async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/env-file/index.js'),
  ...
  it.skip('should overwrite environment variables from a file if passed', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/env-file/index.js'),
      {env: {BAR: 'baz'}},
    );
  ...
  it.skip('should insert environment variables from a file even if entry file is specified with source value in package.json', async function () {
    let b = await bundle(
  ...
  it.skip('should replace process.browser for target browser', async function () {
    let b = await bundle(
  ...
  it.skip('should not touch process.browser for target node', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/process/index.js'),
      {
        targets: {
  ...
  it.skip('should not touch process.browser for target electron-main', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/process/index.js'),
      {
        targets: {
  ...
  it.skip('should replace process.browser for target electron-renderer', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/process/index.js'),
      {
        targets: {
  ...
  it.skip('should resolve the browser field before main', async function () {
    let b = await bundle(
  ...
  it.skip('should exclude resolving specifiers that map to false in the browser field in browser builds', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should not exclude resolving specifiers that map to false in the browser field in node builds', async () => {
    let b = await bundle(
      path.join(
        __dirname,
        '/integration/resolve-entries/pkg-ignore-browser/index.js',
  ...
  it.skip('should resolve the main field', async function () {
    let b = await bundle(
  ...
  it.skip('should ignore require if it is defined in the scope', async function () {
    let b = await bundle(
  ...
  it.skip('should expose to CommonJS entry point', async function () {
    let b = await bundle(
  ...
  it.skip('should expose to RequireJS entry point', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/entry-point/index.js'),
    );
    let test;
  ...
  it.skip('should package successfully with comments on last line', async function () {
    let b = await bundle(
  ...
  it.skip('should package successfully with comments on last line and minification', async function () {
    let b = await bundle(
      path.join(__dirname, `/integration/js-comment/index.js`),
    );
  ...
  it.skip('should package successfully with comments on last line and scope hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, `/integration/js-comment/index.js`),
      {
        defaultTargetOptions: {
  ...
  it.skip('should package successfully with comments on last line, scope hoisting and minification', async function () {
    let b = await bundle(
      path.join(__dirname, `/integration/js-comment/index.js`),
      {
        defaultTargetOptions: {
  ...
  it.skip('should not replace toplevel this with undefined in CommonJS without scope-hoisting', async function () {
    let b = await bundle(
  ...
  it.skip('should not replace toplevel this with undefined in CommonJS when scope-hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, '/integration/js-this-commonjs/a.js'),
      {
        defaultTargetOptions: {
  ...
  it.skip('should replace toplevel this with undefined in ESM without scope-hoisting', async function () {
  ...
  it.skip('should replace toplevel this with undefined in ESM when scope-hoisting', async function () {
    let b = await bundle(
  ...
  it.skip('should support async importing the same module from different bundles', async () => {
    let b = await bundle(
  ...
  it.skip('should not create shared bundles from contents of entries', async () => {
    let b = await bundle(
      ['a.js', 'b.js'].map(entry =>
        path.join(
          __dirname,
  ...
  it.skip('should import the same dependency multiple times in the same bundle', async () => {
    let b = await bundle(
  ...
  it.skip("should inline a bundle's compiled text with `bundle-text`", async () => {
    let b = await bundle(
...
.svg-img {
  ...
  it.skip('should not include the runtime manifest for `bundle-text`', async () => {
    let b = await bundle(
      path.join(__dirname, '/integration/bundle-text/index.js'),
      {
        mode: 'production',
...
.svg-img {
  ...
  it.skip("should inline an HTML bundle's compiled text with `bundle-text`", async () => {
    let b = await bundle(
  ...
  it.skip("should inline a JS bundle's compiled text with `bundle-text` and HMR enabled", async () => {
    let b = await bundle(
  ...
  it.skip("should inline a JS bundle's compiled text with `bundle-text` with symbol propagation", async () => {
    let b = await bundle(
      path.join(__dirname, '/integration/bundle-text/javascript.js'),
      {
        mode: 'production',
  ...
  it.skip("should inline a bundle's compiled text with `bundle-text` asynchronously", async () => {
    let b = await bundle(
...
.svg-img {
  ...
  it.skip('should inline text content as url-encoded text and mime type with `data-url:*` imports', async () => {
  ...
  it.skip('should inline binary content as url-encoded base64 and mime type with `data-url:*` imports', async () => {
    let b = await bundle(
  ...
  it.skip('should detect typescript style async requires in commonjs', async () => {
    let b = await bundle(
  ...
  it.skip('should detect typescript style async requires in commonjs with esModuleInterop flag', async () => {
    let b = await bundle(
  ...
  it.skip('should detect typescript style async requires in commonjs with esModuleInterop flag and arrow functions', async () => {
    let b = await bundle(
  ...
  it.skip('should detect rollup style async requires in commonjs', async () => {
    let b = await bundle(
  ...
  it.skip('should only detect requires that are returned from the promise', async () => {
    let b = await bundle(
  ...
  it.skip('should properly chain a dynamic import wrapped in a Promise.resolve()', async () => {
    let b = await bundle(
  ...
  it.skip('should detect parcel style async requires in commonjs', async () => {
    let b = await bundle(
  ...
  it.skip('can load the same resource when referenced in multiple bundles', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('async dependency can be resolved internally and externally from two different bundles', async () => {
    let b = await bundle(
  ...
  it.skip('should display a codeframe on a Terser parse error', async () => {
  ...
  it.skip('can share sibling bundles reachable from a common dependency', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('can create a bundle starting with a dot', async function () {
    let b = await bundle(
  ...
  it.skip('should not automatically name bundle files starting with a dot', async function () {
    await bundle(
  ...
  it.skip('should support duplicate re-exports without scope hoisting', async function () {
    let b = await bundle(
  ...
  it.skip('should prioritize named exports before re-exports withput scope hoisting (before)', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should prioritize named exports before re-exports without scope hoisting (after)', async () => {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should exclude default from export all declaration', async function () {
    let b = await bundle(
  ...
  it.skip('should not use arrow functions for reexport declarations unless supported', async function () {
    let b = await bundle(
  ...
  it.skip('should support import namespace declarations of other ES modules', async function () {
    let b = await bundle(
  ...
  it.skip('should support import namespace declarations of class from CJS', async function () {
    let b = await bundle(
  ...
  it.skip('should support import namespace declarations of object from CJS', async function () {
    let b = await bundle(
  ...
  it.skip('should support export namespace declarations', async function () {
    let b = await bundle(
  ...
  it.skip('should support export declarations with destructuring', async function () {
    let b = await bundle(
  ...
  it.skip('should support export default declarations', async function () {
    let b = await bundle(
  ...
  it.skip('should hoist function default exports to allow circular imports', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should hoist anonymous function default exports to allow circular imports', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should work with many different types of exports', async function () {
    let b = await bundle(
  ...
  it.skip('should correctly export functions', async function () {
    let b = await bundle(
  ...
  it.skip('should handle exports of imports', async function () {
    let b = await bundle(
  ...
  it.skip('should handle simultaneous import and reexports of the same identifier', async function () {
    let b = await bundle(
  ...
  it.skip('should generate a unique variable name for imports', async function () {
    let b = await bundle(
  ...
  it.skip('should replace an imported identifier with function locals of the same name', async function () {
    let b = await bundle(
  ...
  it.skip('should replace imported values in member expressions', async function () {
    let b = await bundle(
  ...
  it.skip('should retain the correct dependency order between import and reexports', async function () {
    let b = await bundle(
  ...
  it.skip('should not freeze live default imports', async function () {
    let b = await bundle(
  ...
  it.skip('should not rewrite this in arrow function class properties', async function () {
    let b = await bundle(
  ...
  it.skip('should call named imports without this context', async function () {
    let b = await bundle(
  ...
  it.skip('should only replace free references to require', async () => {
    let b = await bundle(
  ...
  it.skip('should only replace free references to require with scope hoisting', async () => {
    let b = await bundle(
      path.join(__dirname, 'integration/js-require-free/index.js'),
      {
        mode: 'production',
  ...
  it.skip('should support import and non-top-level require of same asset from different assets', async () => {
    let b = await bundle(
  ...
  it.skip('should support import and non-top-level require of same asset from different assets with scope hoisting', async () => {
    let b = await bundle(
      path.join(__dirname, 'integration/js-require-import-different/index.js'),
      {
        mode: 'production',
  ...
  it.skip('should support runtime module deduplication', async function () {
    let b = await bundle(
  ...
  it.skip('should support runtime module deduplication with scope hoisting', async function () {
    let b = await bundle(
      path.join(__dirname, 'integration/js-runtime-dedup/index.js'),
      {
        mode: 'production',
  ...
  it.skip('should reuse a bundle when its main asset (aka bundleroot) is imported sychronously', async function () {
    let b = await bundle(
  ...
  describe('multiple import types', function () {
    it.skip('supports both static and dynamic imports to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
    ...
    it.skip('supports both static and dynamic imports to the same specifier in the same file with scope hoisting', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          'integration/multiple-import-types/static-dynamic.js',
    ...
    it.skip('supports static, dynamic, and url to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
    ...
    it.skip('supports static, dynamic, and url to the same specifier in the same file with scope hoisting', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          'integration/multiple-import-types/static-dynamic-url.js',
    ...
    it.skip('supports dynamic import and url to the same specifier in the same file', async function () {
      let b = await bundle(
        path.join(
          __dirname,
    ...
    it.skip('supports dynamic import and url to the same specifier in the same file with scope hoisting', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          'integration/multiple-import-types/dynamic-url.js',
    ...
    it.skip('supports static import and inline bundle for the same asset', async function () {
      let b = await bundle(
        path.join(
          __dirname,
    ...
    it.skip('supports static import and inline bundle for the same asset with scope hoisting', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          'integration/multiple-import-types/static-inline.js',
    ...
    it.skip('supports dynamic import and inline bundle for the same asset', async function () {
      let b = await bundle(
        path.join(
          __dirname,
    ...
    it.skip('supports dynamic import and inline bundle for the same asset with scope hoisting', async function () {
      let b = await bundle(
        path.join(
          __dirname,
          'integration/multiple-import-types/dynamic-inline.js',
  ...
  it.skip('should avoid creating a bundle for lazy dependencies already available in a shared bundle', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip('should support standalone import.meta', async function () {
    let b = await bundle(
  ...
  it.skip('should support importing async bundles from bundles with different dist paths', async function () {
  ...
  it.skip('supports deferring unused ESM imports with sideEffects: false', async function () {
    let b = await bundle(
  ...
  it.skip('supports ESM imports and requires with sideEffects: false', async function () {
    let b = await bundle(
  ...
  it.skip('should not affect ESM import order', async function () {
  ...
  it.skip('should not affect ESM import order with scope hoisting', async function () {
    const b = await bundle(
      path.join(__dirname, '/integration/js-import-initialization/a.mjs'),
      {
        defaultTargetOptions: {
  ...
  it.skip('should not deduplicate an asset if it will become unreachable', async function () {
    let b = await bundle(
      path.join(
        __dirname,
  ...
  it.skip(`should also fail on recoverable parse errors`, async () => {
    await fsFixture(overlayFS, __dirname)`
  ...
  for (let shouldScopeHoist of [false, true]) {
    ...
    describe(`sideEffects: false with${
      ...
      if (usesSymbolPropagation) {
        it.skip('supports excluding unused CSS imports', async function () {
          let b = await bundle(
            path.join(
              __dirname,
        ...
        it.skip("doesn't create new bundles for dynamic imports in excluded assets", async function () {
          let b = await bundle(
            path.join(
              __dirname,
      ...
      it.skip('supports deferring unused ES6 re-exports (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring an unused ES6 re-export (wildcard, empty, unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring unused ES6 re-exports (reexport named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring unused ES6 re-exports (namespace rename used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring unused ES6 re-exports (direct export used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports chained ES6 re-exports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('should not optimize away an unused ES6 re-export and an used import', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('should not optimize away an unused ES6 re-export and an used import (different symbols)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('keeps side effects by default', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports the package.json sideEffects: false flag', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports wildcards', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('correctly handles excluded and wrapped reexport assets', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports the package.json sideEffects flag with an array', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports the package.json sideEffects: false flag with shared dependencies', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('missing exports should be replaced with an empty object', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports namespace imports of theoretically excluded reexporting assets', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports excluding multiple chained namespace reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports excluding when doing both exports and reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring with chained renaming reexports', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and renamed reexports of the same asset (default used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and renamed reexports of the same asset (named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and renamed reexports of the same asset (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports reexports via variable declaration (unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and namespace exports of the same asset (named used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and namespace exports of the same asset (namespace used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports named and namespace exports of the same asset (both used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports partially used reexporting index file', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports deferring non-weak dependencies that are not used', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports excluding CommonJS (CommonJS unused)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
      ...
      it.skip('supports excluding CommonJS (CommonJS used)', async function () {
        let b = await bundle(
          path.join(
            __dirname,
    ...
    it.skip(`ignores missing unused import specifiers in source assets ${
    ...
    it.skip(`ignores missing unused import specifiers in node-modules ${
      shouldScopeHoist ? 'with' : 'without'
    } scope-hoisting`, async function () {
      let b = await bundle(
        path.join(
    ...
    it.skip(`duplicate assets should share module scope  ${
      shouldScopeHoist ? 'with' : 'without'
    } scope-hoisting`, async function () {
      let b = await bundle(
        [
