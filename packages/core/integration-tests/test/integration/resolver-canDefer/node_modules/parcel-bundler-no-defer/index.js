...
const { loadConfig, md5FromString, validateSchema } = require("@parcel/utils");
      ...
      enter: (node, context, actions) => {
        if (node.type !== "dependency") {
          return {
            ...
            parentNode: node,
            parentBundle:
              bundlesByEntryAsset.get(node.value) || (context && context.parentBundle),
          };
        }
        ...
        if (
          ...
          (resolution && resolution.isIsolated) ||
          (resolution && resolution.isInline)
        ) {
          ...
          if (
            ...
            bundleGroup = bundleGraph.createBundleGroup(
              dependency,
              nullthrows(dependency.target || (context && context.bundleGroup && context.bundleGroup.target))
            );
          ...
          for (let asset of assets) {
            ...
            if (bundleGroup === (context && context.bundleGroup)) {
              ...
              bundleGraph.createBundleReference(
                nullthrows(context && context.parentBundle),
                bundle
              );
            }
          }
