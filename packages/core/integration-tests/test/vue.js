...
describe('vue', () => {
  it('should produce a basic vue bundle', async () => {
    let b = await bundle(
  ...
  it('should produce a vue bundle with dependencies', async () => {
    let b = await bundle(
  ...
  it('should produce a vue bundle using preprocessors', async () => {
    let b = await bundle(
  ...
  it('should produce a vue bundle using a functional component', async () => {
    let b = await bundle(
  ...
  it('should produce a vue bundle using scoped styles', async () => {
    let b = await bundle(
  ...
  it('should produce a vue bundle using CSS modules', async () => {
    let b = await bundle(
  ...
  it('should bundle nested components dynamically', async () => {
    let b = await bundle(
  ...
  it('should produce a basic production vue bundle', async () => {
    let b = await bundle(
      path.join(__dirname, '/integration/vue-basic/Basic.vue'),
      {
        production: true
