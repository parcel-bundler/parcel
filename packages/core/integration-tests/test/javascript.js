...
for (let config of configSpecifiers) {
  ...
  describe('javascript with ' + config, function() {
    beforeEach(async () => {
    ...
    it('should minify JS in production mode', async function() {
      let b = await bundle(
        path.join(__dirname, '/integration/uglify/index.js'),
        {
          defaultTargetOptions: {
            shouldOptimize: true,
            shouldScopeHoist: false,
    ...
    it('should use terser config', async function() {
      await bundle(
        path.join(__dirname, '/integration/terser-config/index.js'),
        {
          defaultTargetOptions: {
            shouldOptimize: true,
            shouldScopeHoist: false,
    ...
    it('should insert global variables when needed', async function() {
      let b = await bundle(
        path.join(__dirname, '/integration/globals/index.js'),
      );
    ...
    it('should support requiring CoffeeScript files', async function() {
      let b = await bundle(
        path.join(__dirname, '/integration/coffee/index.js'),
      );
    ...
    it.skip('should resolve advanced browser resolution', async function() {
      let b = await bundle(
        path.join(
          __dirname,
          '/integration/resolve-entries/browser-multiple.js',
        ),
      );
    ...
    it('should minify JSON files', async function() {
      ...
      let json = await outputFS.readFile(
    ...
    it('should throw a diagnostic for unkown pipelines', async function() {
      ...
      await assert.rejects(() => bundle(fixture), {
        ...
        diagnostics: [
          {
            message:
              "Failed to resolve 'strange-pipeline:./b.js' from './a.js'",
            origin: '@parcel/core',
            codeFrames: [
              {
                filePath: fixture,
