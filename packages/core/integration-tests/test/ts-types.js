...
describe('typescript types', function() {
  ...
  it('should generate ts declarations with imports', async function() {
    ...
    assertBundles(b, [
      {
        type: 'js',
        assets: ['index.ts', 'file.ts', 'namespace.ts', 'helpers.js'],
      },
      {
        type: 'ts',
        assets: ['index.ts'],
  ...
  it('should generate ts declarations with exports', async function() {
    ...
    assertBundles(b, [
      {
        type: 'js',
        assets: ['helpers.js', 'index.ts', 'message.ts', 'other.ts', 'test.ts'],
      },
      {
        type: 'ts',
        assets: ['index.ts'],
  ...
  it('should generate ts declarations with externals', async function() {
    ...
    assertBundles(b, [
      {
        type: 'js',
        assets: ['index.tsx', 'other.tsx', 'helpers.js'],
      },
      {
        type: 'ts',
        assets: ['index.tsx'],
